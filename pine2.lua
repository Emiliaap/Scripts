...
local window = uilib:CreateWindow("Pineapple V1")
...
---------
local antiafk = utility:AddSection("Anti AFK")
antiafk_enabled = antiafk:AddSetting("Enabled","Toggle")

local antiafkstate = 0
task.spawn(function()
	while window.ScreenGui.Parent do
		rs.RenderStepped:Wait()
